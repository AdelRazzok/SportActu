  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="pages.php">Paramètres</a>
        </li>
      </ul>
    </div>
  </div>
...
<div id="carouselExampleCaptions" class="carousel slide mt-3 shadow" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://le10static.com/img/cache/article/576x324/0000/0018/187966.jpeg" class="d-block w-100" alt="...">
