<div class="container-fluid p-0 m-0 fixed-bottom" style="overflow: hidden;">
    ...
    <div class="row py-2 footer_bot">
        <div class="col-6 text-center">
            <a href="accueil.html">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-newspaper" viewBox="0 0 16 16">
        ...
        <div class="col-6 text-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-sliders" viewBox="0 0 16 16">
